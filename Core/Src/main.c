...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
  ...
  switch (GPIO_Pin)
  {
    ...
    case COLUMN_2_Pin:
      ...
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_2_GPIO_Port, COLUMN_2_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"2", 1, 10); // Col 2, Row 1
        break;
      }
      HAL_GPIO_WritePin(ROW_2_GPIO_Port, ROW_2_Pin, GPIO_PIN_SET);
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_2_GPIO_Port, COLUMN_2_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"5", 1, 10); // Col 2, Row 2
        break;
      }
      HAL_GPIO_WritePin(ROW_3_GPIO_Port, ROW_3_Pin, GPIO_PIN_SET);
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_2_GPIO_Port, COLUMN_2_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"8", 1, 10); // Col 2, Row 3
        break;
      }
      HAL_GPIO_WritePin(ROW_4_GPIO_Port, ROW_4_Pin, GPIO_PIN_SET);
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_2_GPIO_Port, COLUMN_2_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"0", 1, 10); // Col 2, Row 4
        break;
      }
      break;
    ...
    case COLUMN_3_Pin:
      ...
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_3_GPIO_Port, COLUMN_3_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"3", 1, 10); // Col 3, Row 1
        break;
      }
      HAL_GPIO_WritePin(ROW_2_GPIO_Port, ROW_2_Pin, GPIO_PIN_SET);
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_3_GPIO_Port, COLUMN_3_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"6", 1, 10); // Col 3, Row 2
        break;
      }
      HAL_GPIO_WritePin(ROW_3_GPIO_Port, ROW_3_Pin, GPIO_PIN_SET);
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_3_GPIO_Port, COLUMN_3_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"9", 1, 10); // Col 3, Row 3
        break;
      }
      HAL_GPIO_WritePin(ROW_4_GPIO_Port, ROW_4_Pin, GPIO_PIN_SET);
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_3_GPIO_Port, COLUMN_3_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"#", 1, 10); // Col 3, Row 4
        break;
      }
      break;
    ...
    case COLUMN_4_Pin:
      ...
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_4_GPIO_Port, COLUMN_4_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"A", 1, 10); // Col 4, Row 1
        break;
      }
      HAL_GPIO_WritePin(ROW_2_GPIO_Port, ROW_2_Pin, GPIO_PIN_SET);
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_4_GPIO_Port, COLUMN_4_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"B", 1, 10); // Col 4, Row 2
        break;
      }
      HAL_GPIO_WritePin(ROW_3_GPIO_Port, ROW_3_Pin, GPIO_PIN_SET);
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_4_GPIO_Port, COLUMN_4_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"C", 1, 10); // Col 4, Row 3
        break;
      }
      HAL_GPIO_WritePin(ROW_4_GPIO_Port, ROW_4_Pin, GPIO_PIN_SET);
      HAL_Delay(2);
      if (HAL_GPIO_ReadPin(COLUMN_4_GPIO_Port, COLUMN_4_Pin) == GPIO_PIN_SET) {
        HAL_UART_Transmit(&huart2, (uint8_t *)"D", 1, 10); // Col 4, Row 4
        break;
      }
      break;
  ...
  // Reset all rows after processing
